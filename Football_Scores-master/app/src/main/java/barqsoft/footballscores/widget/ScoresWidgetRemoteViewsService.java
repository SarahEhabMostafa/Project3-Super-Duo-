...
//                    Log.e(TAG, "getViewAt; in if condition");
                ...
                int home_icon_resource = Utilies.getTeamCrestByTeamName(ScoresWidgetRemoteViewsService.this,
                        cursor.getString(cursor.getColumnIndex(DatabaseContract.scores_table.HOME_COL)));
                int away_icon_resource = Utilies.getTeamCrestByTeamName(ScoresWidgetRemoteViewsService.this,
                        cursor.getString(cursor.getColumnIndex(DatabaseContract.scores_table.AWAY_COL)));

                if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1) {
                    remoteViews.setContentDescription(R.id.home_crest, getString(R.string.home));
                }
